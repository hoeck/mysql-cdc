...
;; TODO: add explizit offset parameters to each read-* function
;;       explanation: when mapping the file with an offset>0, some
...
(def binlog-magic (->> [0xfe 0x62 0x69 0x6e] (map byte) byte-array))
